...
/*=====================================================[ CONNECTING  ]==============================================================*/                  	    
	    	...
	    	success('2', 'Connected')
	    	setTimeout( () => {
	    	console.log(color(`[❗] SUBSCRIBE YOUTUBE Nimezz botz`, 'aqua'))
	    	}, 1000)    		    	     	
         	})         	
...
/*=======================================================[ WELCOME ]==============================================================*/                  	    
        ...
        try {
            ...
            if (chat.action == 'add') {
				...
				welkam += `*├─ INTRO BOLEH KAGAK JUGA BOLEH *\n`
				welkam += `*├─ ❏ Nama :*\n`			
				welkam += `*├─ ❏ Umur :* \n`
				welkam += `*├─ ❏ Pacar? :*\n`
            ...
            if (chat.action == 'remove') {
                ...
                ini_out = `kagak usah balik lagi lu babik @${mem.split('@')[0]} balik lagi gua kepret palalu`
...
/*=====================================================[ API VIDEFIKRI ]==============================================================*/                  	                 
            ...
            fs.writeFileSync('./nayla/limit.json', JSON.stringify(_limit))
        	 ...
        	 mess = {
				...
				success: '```Success```',
				error: {
				 bug: '```terjadi kesalahan segera hubungi owner```',
...
*/                                        
                    ...
                    nayla.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, optionsp, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "caption": `JANGAN LUPA MAKAN OM`} } } })                    
                    reply('TUNGGU UPGRADE AN YANG SELANJUTNYA YA ')                     
					break  
		case 'claim':
		...
		case 'daftar':
					...
					const captionnya = `╭─「 *DAH SUKSES FERIVIKASI* 」\n│ \`\`\`regis bot ABW sudah selesai nikmati fitur\`\`\` \n│ \`\`\`SN: ${noSeri}\`\`\`\n│\n│\`\`\`On ${wib}\`\`\`\n│\`\`\` Name : ${pushname}\`\`\`\n│\`\`\`Number : wa.me/${sender.split("@")[0]}\`\`\`\n│\`\`\`To use bot Please\`\`\`\n│\`\`\`send command ${prefix}menu\`\`\`\n│\`\`\`\n│ Users total : ${_Elite.length} Users\`\`\`\n╰─────────────────────────`
